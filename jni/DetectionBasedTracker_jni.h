...
/////////////////////////////////////////////////
JNIEXPORT void JNICALL Java_org_opencv_samples_facedetect_HOGBasedSvm_nativeCreateHog
(JNIEnv * jenv, jclass, jlong thiz, jstring jFileName);

JNIEXPORT void JNICALL Java_org_opencv_samples_facedetect_HOGBasedSvm_nativeCalcDescript
(JNIEnv * jenv, jclass, jlong thiz, jlong imgGrayAddr);

JNIEXPORT void JNICALL Java_org_opencv_samples_facedetect_HOGBasedSvm_nativePredict
(JNIEnv * jenv, jclass, jlong thiz, jlong imgGrayAddr);
